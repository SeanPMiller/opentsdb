...
/**
 * A pool for the multi-get executor.
 * 
 * @since 3.0
 */
public class Tsdb1xMultiGetPool extends BaseObjectPoolAllocator {
  public static final String TYPE = "Tsdb1xMultiGetPool";
  
  private static final TypeToken<?> TYPE_TOKEN = TypeToken.of(Tsdb1xMultiGet.class);
