...
/**
 * A pool for the scanners executor.
 * 
 * @since 3.0
 */
public class Tsdb1xScannersPool extends BaseObjectPoolAllocator {
  public static final String TYPE = "Tsdb1xScannersPool";
  
  private static final TypeToken<?> TYPE_TOKEN = TypeToken.of(Tsdb1xScanners.class);
