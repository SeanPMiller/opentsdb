 ...
 * @since 3.0
 */
public class Tsdb1xScannerPool extends BaseObjectPoolAllocator {
  public static final String TYPE = "Tsdb1xScannerPool";
  
  private static final TypeToken<?> TYPE_TOKEN = TypeToken.of(Tsdb1xScanner.class);
