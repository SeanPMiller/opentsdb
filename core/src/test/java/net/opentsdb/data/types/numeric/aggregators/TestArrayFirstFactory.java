...
public class TestArrayFirstFactory extends BaseTestNumericArray {
  
  @Test
  public void longs() {
    ArrayFirstFactory.ArrayFirst agg = new ArrayFirstFactory.ArrayFirst(false, NON_POOLED);
    ...
    assertArrayEquals(new long[] { 42, -24, 0, 1 }, agg.longArray());
    
    agg = new ArrayFirstFactory.ArrayFirst(false, NON_POOLED);
  ...
  public void longsPooled() {
    ArrayFirstFactory.ArrayFirst agg = new ArrayFirstFactory.ArrayFirst(false, POOLED);
    agg.accumulate(new long[] { 42, -24, 0, 1 });
    agg.accumulate(new long[] { 3, -13, 5, -1 });
    ...
    assertEquals(0, agg.offset());
    assertEquals(4, agg.end());
    assertPooledArrayEquals(new long[] { 42, -24, 0, 1 }, agg.longArray());
    ...
    before();
    agg = new ArrayFirstFactory.ArrayFirst(false, POOLED);
    agg.accumulate(new long[] { });
    agg.accumulate(new long[] { });
  ...
  public void doubles() throws Exception {
    ...
    // infectious nans
    agg = new ArrayFirstFactory.ArrayFirst(true, NON_POOLED);
    agg.accumulate(new double[] { 42, -24, 0, Double.NaN });
    agg.accumulate(new double[] { 3, Double.NaN, 5, -1 });
    ...
    assertEquals(0, agg.offset());
    assertEquals(4, agg.end());
    assertArrayEquals(new double[] { 42, -24, 0, Double.NaN }, 
  ...
  public void doublesPooled() throws Exception {
    ...
    // infectious nans
    before();
    agg = new ArrayFirstFactory.ArrayFirst(true, POOLED);
    agg.accumulate(new double[] { 42, -24, 0, Double.NaN });
    agg.accumulate(new double[] { 3, Double.NaN, 5, -1 });
    ...
    assertEquals(0, agg.offset());
    assertEquals(4, agg.end());
    assertPooledArrayEquals(new double[] { 42, -24, 0, Double.NaN }, 
        agg.doubleArray(), 0.001);
  ...
  public void accumulateDoublesIndexed() throws Exception {
    ArrayFirstFactory.ArrayFirst agg = 
        new ArrayFirstFactory.ArrayFirst(DefaultArrayAggregatorConfig
          .newBuilder()
          .setArraySize(4)
          .build(), 
        NON_POOLED);
    ...
    assertArrayEquals(new double[] { 42, -24, 0, -1 }, 
        agg.double_accumulator, 0.001);
  ...
  public void accumulateDoublesIndexedPooled() throws Exception {
    ...
    agg.accumulate(5.0, 2);
    agg.accumulate(-1.0, 3);
    assertPooledArrayEquals(new double[] { 42, -24, 0, -1 }, 
        agg.double_accumulator, 0.001);
  ...
  public void offsetsPooled() throws Exception {
    ...
    assertEquals(0, agg.offset());
    assertEquals(2, agg.end());
    assertPooledArrayEquals(new long[] { -24, 0 }, agg.longArray());
    assertPoolCounters(LONG_POOL, 1, 0, 0, 0);
    assertPoolCounters(DOUBLE_POOL, 0, 0, 0, 0);
    agg.close();
    assertPoolCounters(LONG_POOL, 1, 0, 0, 1);
    ...
    assertEquals(0, agg.offset());
    assertEquals(2, agg.end());
    assertPooledArrayEquals(new double[] { -24, 0 }, agg.doubleArray(), 0.001);
    assertPoolCounters(LONG_POOL, 0, 0, 0, 0);
    assertPoolCounters(DOUBLE_POOL, 1, 0, 0, 0);
    agg.close();
