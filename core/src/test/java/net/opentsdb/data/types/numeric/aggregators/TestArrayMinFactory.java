...
public class TestArrayMinFactory extends BaseTestNumericArray {
  
  @Test
  public void longs() {
    ArrayMinFactory.ArrayMin agg = new ArrayMinFactory.ArrayMin(false, NON_POOLED);
    ...
    agg = new ArrayMinFactory.ArrayMin(false, NON_POOLED);
  ...
  public void longsPooled() {
    ArrayMinFactory.ArrayMin agg = new ArrayMinFactory.ArrayMin(false, POOLED);
    agg.accumulate(new long[] { 42, -24, 0, 1 });
    agg.accumulate(new long[] { 3, -13, 5, -1 });
    ...
    assertEquals(0, agg.offset());
    assertEquals(4, agg.end());
    assertPooledArrayEquals(new long[] { 3, -24, 0, -1 }, agg.longArray());
    ...
    before();
    agg = new ArrayMinFactory.ArrayMin(false, POOLED);
    agg.accumulate(new long[] { });
    agg.accumulate(new long[] { });
  ...
  public void doubles() throws Exception {
    ...
    // infectious nans
    agg = new ArrayMinFactory.ArrayMin(true, NON_POOLED);
    agg.accumulate(new double[] { 42, -24, 0, Double.NaN });
    agg.accumulate(new double[] { 3, Double.NaN, 5, -1 });
  ...
  public void doublesPooled() throws Exception {
    ...
    assertEquals(0, agg.offset());
    assertEquals(4, agg.end());
    assertPooledArrayEquals(new double[] { 3, -24, 0, -1 }, agg.doubleArray(), 0.001);
    ...
    // infectious nans
    before();
    agg = new ArrayMinFactory.ArrayMin(true, POOLED);
    agg.accumulate(new double[] { 42, -24, 0, Double.NaN });
    agg.accumulate(new double[] { 3, Double.NaN, 5, -1 });
    ...
    assertEquals(0, agg.offset());
    assertEquals(4, agg.end());
    assertPooledArrayEquals(new double[] { 3, Double.NaN, 0, Double.NaN }, 
        agg.doubleArray(), 0.001);
  ...
  public void accumulateDoublesIndexed() throws Exception {
    ArrayMinFactory.ArrayMin agg = new ArrayMinFactory.ArrayMin(
    ...
    assertArrayEquals(new double[] { 3, -24, 0, -1 }, 
        agg.double_accumulator, 0.001);
  ...
  public void accumulateDoublesIndexedPooled() throws Exception {
    ...
    agg.accumulate(5.0, 2);
    agg.accumulate(-1.0, 3);
    assertPooledArrayEquals(new double[] { 3, -24, 0, -1 }, 
        agg.double_accumulator, 0.001);
