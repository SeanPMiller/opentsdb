...
public class TestWeightedMovingAverage {
  ...
  public void factory() throws Exception {
    ...
    NumericAggregatorFactory factory = new WeightedMovingAverageFactory();
    assertNull(factory.initialize(tsdb, null).join());
    assertEquals(WeightedMovingAverageFactory.TYPE, factory.id());
  ...
  public void run() throws Exception {
    ...
    assertEquals(2.333, dp.doubleValue(), 0.001);
    
    agg.run(new long[] { 1, 2, 3 }, 0, 2, dp);
    assertEquals(1.666, dp.doubleValue(), 0.001);
