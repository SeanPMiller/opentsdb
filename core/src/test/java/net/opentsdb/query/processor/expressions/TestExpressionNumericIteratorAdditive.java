...
public class TestExpressionNumericIteratorAdditive extends BaseNumericTest {
  ...
  public void longLong() throws Exception {
    ...
    assertEquals(15, value.value().longValue());
  ...
  public void longDouble() throws Exception {
    ...
    value = (TimeSeriesValue<NumericType>) iterator.next();
    assertEquals(3000, value.timestamp().msEpoch());
    assertEquals(15.75, value.value().doubleValue(), 0.001);
    
    value = (TimeSeriesValue<NumericType>) iterator.next();
    assertEquals(5000, value.timestamp().msEpoch());
    assertEquals(10.9, value.value().doubleValue(), 0.001);
    assertFalse(iterator.hasNext());
    ...
    value = (TimeSeriesValue<NumericType>) iterator.next();
    assertEquals(1000, value.timestamp().msEpoch());
    assertEquals(-3.5, value.value().doubleValue(), 0.001);
    
    value = (TimeSeriesValue<NumericType>) iterator.next();
    assertEquals(3000, value.timestamp().msEpoch());
    assertEquals(-5.75, value.value().doubleValue(), 0.001);
    
    value = (TimeSeriesValue<NumericType>) iterator.next();
    assertEquals(5000, value.timestamp().msEpoch());
    assertEquals(-6.9, value.value().doubleValue(), 0.001);
    assertFalse(iterator.hasNext());
  }
  ...
  public void doubleDouble() throws Exception {
    ...
    TimeSeriesValue<NumericType> value = 
        (TimeSeriesValue<NumericType>) iterator.next();
    assertEquals(1000, value.timestamp().msEpoch());
    assertEquals(5.6, value.value().doubleValue(), 0.001);
    
    value = (TimeSeriesValue<NumericType>) iterator.next();
    assertEquals(3000, value.timestamp().msEpoch());
    assertEquals(16.08, value.value().doubleValue(), 0.001);
    
    value = (TimeSeriesValue<NumericType>) iterator.next();
    assertEquals(5000, value.timestamp().msEpoch());
    assertEquals(11.56, value.value().doubleValue(), 0.001);
    assertFalse(iterator.hasNext());
    ...
    value = (TimeSeriesValue<NumericType>) iterator.next();
    assertEquals(1000, value.timestamp().msEpoch());
    assertEquals(-3.4, value.value().doubleValue(), 0.001);
    
    value = (TimeSeriesValue<NumericType>) iterator.next();
    assertEquals(3000, value.timestamp().msEpoch());
    assertEquals(-5.42, value.value().doubleValue(), 0.001);
    
    value = (TimeSeriesValue<NumericType>) iterator.next();
    assertEquals(5000, value.timestamp().msEpoch());
    assertEquals(-6.24, value.value().doubleValue(), 0.001);
    assertFalse(iterator.hasNext());
  }
  ...
  public void numericLiteralLeft() throws Exception {
    ...
    TimeSeriesValue<NumericType> value = 
        (TimeSeriesValue<NumericType>) iterator.next();
    assertEquals(1000, value.timestamp().msEpoch());
    assertEquals(46, value.value().longValue());
    
    value = (TimeSeriesValue<NumericType>) iterator.next();
    assertEquals(3000, value.timestamp().msEpoch());
    assertEquals(52, value.value().longValue());
    ...
    value = (TimeSeriesValue<NumericType>) iterator.next();
    assertEquals(1000, value.timestamp().msEpoch());
    assertEquals(38, value.value().longValue());
    
    value = (TimeSeriesValue<NumericType>) iterator.next();
    assertEquals(3000, value.timestamp().msEpoch());
    assertEquals(32, value.value().longValue());
    
    value = (TimeSeriesValue<NumericType>) iterator.next();
    assertEquals(5000, value.timestamp().msEpoch());
    assertEquals(34, value.value().longValue());
    assertFalse(iterator.hasNext());
  }
  ...
  public void booleanLeft() throws Exception {
    ...
    value = (TimeSeriesValue<NumericType>) iterator.next();
    assertEquals(3000, value.timestamp().msEpoch());
    assertEquals(11, value.value().longValue());
    
    value = (TimeSeriesValue<NumericType>) iterator.next();
    assertEquals(5000, value.timestamp().msEpoch());
    assertEquals(9, value.value().longValue());
    ...
    value = (TimeSeriesValue<NumericType>) iterator.next();
    assertEquals(5000, value.timestamp().msEpoch());
    assertEquals(-7, value.value().longValue());
    assertFalse(iterator.hasNext());
  }
