...
public class TestMergerNumericIterator {
  ...
  public void ctor() throws Exception {
    MergerNumericIterator iterator = new MergerNumericIterator(node, result, source_map);
    assertTrue(iterator.hasNext());
    
    iterator = new MergerNumericIterator(node, result, source_map.values());
    assertTrue(iterator.hasNext());
    
    try {
      new MergerNumericIterator(null, result, source_map);
      fail("Expected IllegalArgumentException");
    } catch (IllegalArgumentException e) { }
    
    try {
      new MergerNumericIterator(node, result, (Map<String, TimeSeries>) null);
      fail("Expected IllegalArgumentException");
    } catch (IllegalArgumentException e) { }
    
    try {
      new MergerNumericIterator(node, result, Maps.newHashMap());
      fail("Expected IllegalArgumentException");
    } catch (IllegalArgumentException e) { }
    
    try {
      new MergerNumericIterator(null, result, source_map.values());
      fail("Expected IllegalArgumentException");
    } catch (IllegalArgumentException e) { }
    
    try {
      new MergerNumericIterator(node, result, (Collection<TimeSeries>) null);
      fail("Expected IllegalArgumentException");
    } catch (IllegalArgumentException e) { }
    
    try {
      new MergerNumericIterator(node, result, Lists.newArrayList());
      fail("Expected IllegalArgumentException");
    } catch (IllegalArgumentException e) { }
    
    try {
      new MergerNumericIterator(node, result, Lists.newArrayList(ts1, null, ts3));
      fail("Expected IllegalArgumentException");
    } catch (IllegalArgumentException e) { }
