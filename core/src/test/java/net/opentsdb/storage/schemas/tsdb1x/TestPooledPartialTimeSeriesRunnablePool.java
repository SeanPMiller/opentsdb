...
public class TestPooledPartialTimeSeriesRunnablePool {
  ...
  public void initialize() throws Exception {
    ...
    PooledPartialTimeSeriesRunnablePool allocator = new PooledPartialTimeSeriesRunnablePool();
    assertNull(allocator.initialize(TSDB, null).join());
    assertEquals(PooledPartialTimeSeriesRunnablePool.TYPE, allocator.id());
