...
public class TestTsdb1xNumericSummaryPartialTimeSeriesPool {
  ...
  public void initialize() throws Exception {
    ...
    Tsdb1xNumericSummaryPartialTimeSeriesPool allocator = new Tsdb1xNumericSummaryPartialTimeSeriesPool();
    assertNull(allocator.initialize(TSDB, null).join());
    assertEquals(Tsdb1xNumericSummaryPartialTimeSeriesPool.TYPE, allocator.id());
