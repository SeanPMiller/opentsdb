 ...
 *  @since 3.0
 */
public class NoDataPartialTimeSeriesPool extends BaseObjectPoolAllocator {
  public static final String TYPE = "NoDataPartialTimeSeriesPool";
  
  private static final TypeToken<?> TYPE_TOKEN = TypeToken.of(
      NoDataPartialTimeSeries.class);
