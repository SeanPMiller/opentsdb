...
/**
 * An allocator pool for sets
 * 
 * @since 3.0
 */
public class Tsdb1xPartialTimeSeriesSetPool extends BaseObjectPoolAllocator {
  public static final String TYPE = "Tsdb1xPartialTimeSeriesSet";
  public static final TypeToken<?> TYPE_TOKEN = TypeToken.of(
      Tsdb1xPartialTimeSeriesSet.class);
  ...
  public Object allocate() {
    return new Tsdb1xPartialTimeSeriesSet(tsdb);
  }
