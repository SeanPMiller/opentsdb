...
public class ArrayMaxFactory extends BaseArrayFactory {
  ...
  public NumericArrayAggregator newAggregator() {
    return new ArrayMax(false, this);
  }
  ...
  public NumericArrayAggregator newAggregator(final AggregatorConfig config) {
    if (config != null && config instanceof NumericArrayAggregatorConfig) {
      return new ArrayMax((NumericArrayAggregatorConfig) config, this);
    }
    return new ArrayMax(false, this);
  }
  ...
  public NumericArrayAggregator newAggregator(final boolean infectious_nan) {
    return new ArrayMax(infectious_nan, this);
  }
  ...
  public static class ArrayMax extends BaseArrayAggregator {
    ...
    public ArrayMax(final NumericArrayAggregatorConfig config,
                    final BaseArrayFactory factory) {
